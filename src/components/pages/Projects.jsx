  ...
  return (
    <section className="projects-section text-white">
        ...
        >
          ...
          <a href="https://proyecto-pricing-o9or.vercel.app/" target='_blank'><img src='/Pricing.png' alt="Preview Project Pricing" /></a>
        </VerticalTimelineElement>
        <VerticalTimelineElement 
          className="vertical-timeline-element--education"
          date="2024"
          ...
          <a href="https://piano-virtual-gold.vercel.app/" target='_blank'><img src='/PianoVirtual.png' alt="Preview Piano Project" /></a>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        className="vertical-timeline-element--education"
        date="2024"
